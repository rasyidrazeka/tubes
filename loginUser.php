                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    <h2 class="fw-bold mb-2 text-uppercase">LOGIN PEMBELI</h2><br>
                                    <?php
                                        if(isset($_GET["error"])){
                                            $error = $_GET["error"];
                                        }
                                    ...
                                    <form action="loginUsPros.php" method="post">
                                    ...
                                    <div>
                                        <br>
                                        <p class="mb-0">Tidak memiliki akun? <a href="daftarUser.php" class="text-white-50 fw-bold">Daftar</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
