...
<html lang="en">
    <head>
        ...
        <title>Login | FR Shoes Store ID</title>
    </head>
    <body>
                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    <h2 class="fw-bold mb-2 text-uppercase">DAFTAR GAGAL</h2><br>
                                    <p class="text-white-50 mb-5">Pendaftaran akun anda telah gagal. Silahkan coba mendaftar lagi!</p>
                                    <a href="daftarUser.php"><button class="btn btn-outline-light btn-lg px-5" type="submit" name="login">Daftar</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
