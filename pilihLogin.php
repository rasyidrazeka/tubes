                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    <h2 class="fw-bold mb-2 text-uppercase">LOGIN SEBAGAI</h2><br>
                                    <br>
                                    <div class="d-grid gap-2">
                                        <a href="loginAdmin.php"><button class="btn btn-primary" type="button">LOGIN SEBAGAI ADMIN</button></a>
                                        <br><br><br>
                                        <a href="loginUser.php"><button class="btn btn-primary" type="button">LOGIN SEBAGAI PEMBELI</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
